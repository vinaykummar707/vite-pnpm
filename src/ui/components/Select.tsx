...
>(function TriggerValue(
  ...
  return (
    <SubframeCore.Select.Value
      className={SubframeUtils.twClassNames(
        "w-full whitespace-nowrap text-body-bold font-body-bold text-default-font",
        className
      )}
      ref={ref}
    ...
    return (
      ...
      >
        ...
        >
          ...
          <div
            className={SubframeUtils.twClassNames(
              "flex h-9 w-full flex-none flex-col items-start rounded-md border border-solid border-neutral-border bg-default-background group-focus-within/bb88f90b:border group-focus-within/bb88f90b:border-solid group-focus-within/bb88f90b:border-brand-primary",
              {
